var LiveMonacoEditor = (() => {
  ...
  var moonlight_ii_default = {
    ...
    rules: [
      ...
      // gray10
      // DOM Variables
      { token: "variable.dom", foreground: "ffc777" },
      // yellow
      ...
      // gray8
      { token: "property.declaration", foreground: "4fd6be" },
      // teal
      // Keywords
      { token: "keyword", foreground: "c099ff", fontStyle: "italic" },
      // purple
      { token: "keyword.control", foreground: "c099ff", fontStyle: "italic" },
      // purple
      ...
      // cyan
      { token: "punctuation", foreground: "86e1fc" },
      // cyan
      // Tags
      ...
      // blue
      { token: "function.call", foreground: "65bcff" },
      // sky
      // Constants
      ...
      // orange
      { token: "boolean", foreground: "ff966c" },
      // orange
      // Function Parameters
      { token: "parameter", foreground: "f0a1a8" },
      // pink
      // Strings
      { token: "string", foreground: "c3e88d" },
      // green
      // Regular Expressions
      { token: "regexp", foreground: "7fdaff" },
      // lightCyan
      // Types
      { token: "type", foreground: "ffc777" },
      // yellow
      { token: "type.builtin", foreground: "ff966c" },
      // orange
      // Class
      { token: "class", foreground: "ffc777" },
      // yellow
      // Language variables (this, self, etc.)
      { token: "variable.language", foreground: "ff757f", fontStyle: "italic" },
      // red
      // Object
      { token: "variable.object", foreground: "ffc777" },
      // yellow
      // CSS properties
